...
import { BarChart3, Bot, ChevronRight, Code2, Flame, Home, ListChecks, Swords, Trophy, UsersRound } from "lucide-react";
    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-profile">
        <div className="side-user-row">
          <span className="side-avatar">{user?.name?.slice(0, 1) ?? "U"}</span>
          <div>
